...
//                        ->visible(fn(LeaveRequest $record) => true),
    ...
    {
        $user = Auth::user();
        if ($user->hasRole('admin') || $user->hasRole('humanResources')) {
            return parent::getEloquentQuery();
        }
        return parent::getEloquentQuery()->where('userID', $user->id); // TODO: Change the autogenerated stub
    }
